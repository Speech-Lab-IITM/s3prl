...
from s3prl.downstream.runner_ensemble import Runner
...
def get_downstream_args():
    ...
    parser.add_argument('-u', '--upstream', nargs='+',  help=""
    ...
    parser.add_argument('-lw', '--upstream_layers_for_ws_wav2vec2',  nargs='+', help='Select specific layers for the features selected by -s and weighted sum for wav2vec2')
    parser.add_argument('-lh', '--upstream_layers_for_ws_hubert',  nargs='+', help='Select specific layers for the features selected by -s and weighted sum for hubert')
    parser.add_argument('-lwl', '--upstream_layers_for_ws_wavlm',  nargs='+', help='Select specific layers for the features selected by -s and weighted sum for wavlm')
